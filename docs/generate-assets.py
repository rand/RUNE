#!/usr/bin/env python3
"""
Generate favicon PNGs and og-image for RUNE
...
draw.text((symbol_x, symbol_y), "∮", fill=PURPLE, font=symbol_font)
...
# Draw subtitle
subtitle = "High-Performance Authorization & Configuration"
...
# Draw tagline
tagline = "Sub-millisecond decisions at 5M+ ops/sec"
